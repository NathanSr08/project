...
class getDoctrine_Fixtures_LoaderService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addFixtures([0 => ['fixture' => ($container->privates['App\\DataFixtures\\AppFixtures'] ?? ($container->privates['App\\DataFixtures\\AppFixtures'] = new \App\DataFixtures\AppFixtures())), 'groups' => []], 1 => ['fixture' => ($container->privates['App\\DataFixtures\\UsersFixtures'] ?? $container->load('getUsersFixturesService')), 'groups' => []]]);
