...
class __TwigTemplate_8439fb51525e56617fe506106dc43ea8b0c78d030824d1d0ec33b5f89b6b188e extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 20
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "Nom", [], "any", false, false, false, 20), 'row');
        echo "
";
        // line 21
...
";
        // line 34
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "id_adm", [], "any", false, false, false, 34), 'row', ["attr" => ["value" => ($context["ID"] ?? null)]]);
        echo "
...
";
    ...
    {
        return new Source("", "client/add.html.twig", "/home/sio/docker-symfony/project/templates/client/add.html.twig");
    }
}
