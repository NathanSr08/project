   ...
   <div class=\"form-group\">
     ...
     <div class=\"form-group\">
      ...
      <textarea class=\"form-control\"  name=\"sms[sms]\" rows=\"3\" placeholder=\"";
            // line 28
            echo twig_escape_filter($this->env, twig_striptags(twig_get_attribute($this->env, $this->source, $context["sms"], "sms", [], "any", false, false, false, 28)), "html", null, true);
...
<button type=\"button\" class=\"btn btn-outline-primary disabled\">{{sms.date}}</button>
  ...
  <div class=\"form-group\">
   ...
   <div class=\"form-group\">
     ...
     <div class=\"form-group\">
      <label for=\"exampleTextarea\" class=\"form-label mt-4\">Message</label>
      <textarea class=\"form-control\"  name=\"sms[sms]\" rows=\"3\" placeholder=\"{{sms.sms|striptags}}\" disabled=\"\"></textarea>
    </div>
